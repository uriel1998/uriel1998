...
These are programs and utilities that I have modified in some way and (for whatever reason) 
a PR was inappropriate (due to inactivity), unwelcome, or unneeded, but I find it useful.  
...
These scripts may need work before they're functional due to bitrot, changed standards, 
services ceasing functioning, or my own error.
